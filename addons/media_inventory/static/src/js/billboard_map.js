            ...
            const popupContent = `
                <div class="site-popup">
                    ...
                    <div class="popup-body mt-2">
                        <img src="/web/image/${this.siteModel}/${site.id}/main_image" style="width: 100%; max-height: 120px; object-fit: cover; border-radius: 4px; margin-bottom: 8px;" onerror="this.style.display='none'"/>
