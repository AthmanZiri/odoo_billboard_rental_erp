...
class Uom(models.Model):
    ...
    vscu_l10n_ke_quantity_unit_id = fields.Many2one(
        'l10n_ke_etims_vscu_v19.code',
        readonly=False,
    ...
    def _l10n_ke_get_validation_messages(self):
        ...
        misconfigured_uoms = self.filtered(lambda u: not u.vscu_l10n_ke_quantity_unit_id)
    ...
    def _l10n_ke_action_open_uoms(self, title=None):
        ...
        res = {
            ...
            'view_mode': 'tree',
            'views': [(self.env.ref('l10n_ke_etims_vscu_v19.product_uom_l10n_ke_tree').id, 'tree'), (False, 'form')],
