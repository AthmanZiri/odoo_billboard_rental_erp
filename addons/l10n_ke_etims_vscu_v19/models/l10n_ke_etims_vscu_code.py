...
class L10nKeVSCUCode(models.Model):
    _name = 'l10n_ke_etims_vscu_v19.code'
    ...
    def _create_or_update_from_vals(self, create_vals):
        ...
        :param list[dict] create_vals: list of l10n_ke_etims_vscu_v19.code creation vals.
        ...
        model_data_values = [
            {
                ...
                'model': 'l10n_ke_etims_vscu_v19.code',
                'module': 'l10n_ke_etims_vscu_v19',
                'res_id': code.id,
                'noupdate': True,
            }
            for code in created
