...
class ResCompany(models.Model):
    ...
    l10n_ke_vscu_is_active = fields.Boolean(
        string="OSCU is Active",
         default = True
    ) # Should be true for any installed vscu module
    ...
    def action_l10n_ke_get_items(self):
        ...
        """
        last_request_date = self.env['ir.config_parameter'].get_param('l10n_ke_etims_vscu_v19.last_fetch_items_request_date', '20180101000000')
    ...
    def _l10n_ke_get_demo_response(self, urlext, content):
        ...
        module = 'l10n_ke_etims_vscu_stock' if urlext in stock_services else 'l10n_ke_etims_vscu_v19'

        response_files = {
            'insertTrnsPurchase': 'success',
            'insertStockIO': 'success',
            'items/saveItems': 'success',
