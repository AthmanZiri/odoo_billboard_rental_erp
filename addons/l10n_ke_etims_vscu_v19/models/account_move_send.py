...
class AccountMoveSend(models.AbstractModel):
    ...
    @api.model
    def _is_vscu_applicable(self, move):
        return move.company_id.l10n_ke_vscu_is_active and not move.l10n_ke_oscu_receipt_number

    def _get_all_extra_edis(self) -> dict:
        # EXTENDS 'account'
        res = super()._get_all_extra_edis()
        res.update({'ke_oscu': {'label': _("Send to eTIMS"), 'is_applicable': self._is_vscu_applicable}})
        return res
