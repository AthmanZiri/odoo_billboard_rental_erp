...
class TestKeEdiCommon(TestAccountMoveSendCommon):
    ...
    def setUpClass(cls):
        ...
        cls.product_service = cls.env['product.product'].create([{
            ...
            'vscu_l10n_ke_packaging_unit_id': cls.env.ref('l10n_ke_etims_vscu_v19.code_17_OU').id,
    ...
    def patch_session(self, responses):
        """ Patch requests.Session in l10n_ke_etims_vscu_v19/models/company.py """
        ...
        class MockedSession:
            ...
            def post(self, url, json=None, timeout=None):
                ...
                module = 'l10n_ke_etims_vscu_stock' if service in stock_services else 'l10n_ke_etims_vscu_v19'
        ...
        with mock.patch('odoo.addons.l10n_ke_etims_vscu_v19.models.res_company.requests.Session', side_effect=MockedSession, autospec=True) as mock_session:
            yield mock_session
    ...
    def create_reversal(self, invoice, is_modify=False):
        ...
        wizard_reverse.write({
            'reason': 'Return',
            'l10n_ke_reason_code_id': self.env.ref('l10n_ke_etims_vscu_v19.code_32_06').id,
        })
