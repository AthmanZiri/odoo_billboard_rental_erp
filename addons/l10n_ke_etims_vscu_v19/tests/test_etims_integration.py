...
class TestEtimsIntegration(TransactionCase):
    ...
    def test_01_company_configuration(self):
        ...
        self.assertTrue(self.company.l10n_ke_vscu_is_active)
    ...
    @patch('odoo.addons.l10n_ke_etims_vscu_v19.models.res_company.requests.Session')
    ...
    def test_15_module_installation_compatibility(self):
        ...
        self.assertTrue(self.env['l10n_ke_etims_vscu_v19.code'])
        self.assertTrue(self.env['l10n_ke_etims_vscu_v19.notice'])
