...
from odoo.addons.l10n_ke_etims_vscu_v19.tests.common import TestKeEdiCommon
...
class TestKeEdi(TestKeEdiCommon):
    ...
    def _test_update_codes(self):
        ...
        self.env['l10n_ke_etims_vscu_v19.code']._cron_get_codes_from_device()
    ...
    def _test_update_notices(self):
        ...
        self.env.ref('l10n_ke_etims_vscu_v19.ir_cron_fetch_notice').method_direct_trigger()
    ...
    def _test_update_unspsc_codes(self):
        ...
        self.env.ref('l10n_ke_etims_vscu_v19.ir_cron_fetch_unspsc').method_direct_trigger()
    ...
    def _test_confirm_vendor_bill(self, vendor_bill):
        ...
        vendor_bill.l10n_ke_payment_method_id = self.env.ref('l10n_ke_etims_vscu_v19.code_07_05')
